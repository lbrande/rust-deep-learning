...
pub const DNN_MAX_DIMENSION : u32 = 32;
pub const DNN_QUERY_MAX_LENGTH : u32 = 128;
...
} # [ repr ( C ) ] # [ derive ( Debug , Copy , Clone ) ] pub struct _uniPrimitive_s { _unused : [ u8;
0 ] , } pub type dnnPrimitive_t = * mut _uniPrimitive_s;
# [ repr ( C ) ] # [ derive ( Debug , Copy , Clone ) ] pub struct _dnnLayout_s { _unused : [ u8;
0 ] , } pub type dnnLayout_t = * mut _dnnLayout_s;
pub type dnnPrimitiveAttributes_t = * mut :: std :: os :: raw :: c_void;
pub const dnnError_t_E_SUCCESS : dnnError_t = 0;
pub const dnnError_t_E_INCORRECT_INPUT_PARAMETER : dnnError_t = -1;
pub const dnnError_t_E_UNEXPECTED_NULL_POINTER : dnnError_t = -2;
pub const dnnError_t_E_MEMORY_ERROR : dnnError_t = -3;
pub const dnnError_t_E_UNSUPPORTED_DIMENSION : dnnError_t = -4;
pub const dnnError_t_E_UNIMPLEMENTED : dnnError_t = -127;
pub type dnnError_t = i32;
# [ doc = " GEMM base convolution (unimplemented)" ] pub const dnnAlgorithm_t_dnnAlgorithmConvolutionGemm : dnnAlgorithm_t = 0;
# [ doc = " Direct convolution" ] pub const dnnAlgorithm_t_dnnAlgorithmConvolutionDirect : dnnAlgorithm_t = 1;
# [ doc = " FFT based convolution (unimplemented)" ] pub const dnnAlgorithm_t_dnnAlgorithmConvolutionFFT : dnnAlgorithm_t = 2;
# [ doc = " Maximum pooling" ] pub const dnnAlgorithm_t_dnnAlgorithmPoolingMax : dnnAlgorithm_t = 3;
# [ doc = " Minimum pooling" ] pub const dnnAlgorithm_t_dnnAlgorithmPoolingMin : dnnAlgorithm_t = 4;
# [ doc = " Average pooling (padded values are not taken into account)" ] pub const dnnAlgorithm_t_dnnAlgorithmPoolingAvgExcludePadding : dnnAlgorithm_t = 5;
# [ doc = " Alias for average pooling (padded values are not taken into account)" ] pub const dnnAlgorithm_t_dnnAlgorithmPoolingAvg : dnnAlgorithm_t = 5;
# [ doc = " Average pooling (padded values are taken into account)" ] pub const dnnAlgorithm_t_dnnAlgorithmPoolingAvgIncludePadding : dnnAlgorithm_t = 6;
pub type dnnAlgorithm_t = u32;
pub const dnnResourceType_t_dnnResourceSrc : dnnResourceType_t = 0;
pub const dnnResourceType_t_dnnResourceFrom : dnnResourceType_t = 0;
pub const dnnResourceType_t_dnnResourceDst : dnnResourceType_t = 1;
pub const dnnResourceType_t_dnnResourceTo : dnnResourceType_t = 1;
pub const dnnResourceType_t_dnnResourceFilter : dnnResourceType_t = 2;
pub const dnnResourceType_t_dnnResourceScaleShift : dnnResourceType_t = 2;
pub const dnnResourceType_t_dnnResourceBias : dnnResourceType_t = 3;
pub const dnnResourceType_t_dnnResourceMean : dnnResourceType_t = 3;
pub const dnnResourceType_t_dnnResourceDiffSrc : dnnResourceType_t = 4;
pub const dnnResourceType_t_dnnResourceDiffFilter : dnnResourceType_t = 5;
pub const dnnResourceType_t_dnnResourceDiffScaleShift : dnnResourceType_t = 5;
pub const dnnResourceType_t_dnnResourceDiffBias : dnnResourceType_t = 6;
pub const dnnResourceType_t_dnnResourceVariance : dnnResourceType_t = 6;
pub const dnnResourceType_t_dnnResourceDiffDst : dnnResourceType_t = 7;
pub const dnnResourceType_t_dnnResourceWorkspace : dnnResourceType_t = 8;
pub const dnnResourceType_t_dnnResourceMultipleSrc : dnnResourceType_t = 16;
pub const dnnResourceType_t_dnnResourceMultipleDst : dnnResourceType_t = 24;
pub const dnnResourceType_t_dnnResourceNumber : dnnResourceType_t = 32;
pub type dnnResourceType_t = u32;
pub const dnnBorder_t_dnnBorderZeros : dnnBorder_t = 0;
pub const dnnBorder_t_dnnBorderZerosAsymm : dnnBorder_t = 256;
pub const dnnBorder_t_dnnBorderExtrapolation : dnnBorder_t = 3;
pub type dnnBorder_t = u32;
pub const dnnBatchNormalizationFlag_t_dnnUseInputMeanVariance : dnnBatchNormalizationFlag_t = 1;
pub const dnnBatchNormalizationFlag_t_dnnUseScaleShift : dnnBatchNormalizationFlag_t = 2;
pub type dnnBatchNormalizationFlag_t = u32;
extern "C" { # [ doc = " F32 section: single precision" ] pub fn dnnLayoutCreate_F32 ( pLayout : * mut dnnLayout_t , dimension : usize , size : * const usize , strides : * const usize ) -> dnnError_t;
} extern "C" { pub fn dnnLayoutCreateFromPrimitive_F32 ( pLayout : * mut dnnLayout_t , primitive : dnnPrimitive_t , type_ : dnnResourceType_t ) -> dnnError_t;
} extern "C" { # [ doc = " Returns the size of buffer required to serialize dnnLayout_t structure." ] pub fn dnnLayoutSerializationBufferSize_F32 ( ) -> usize;
} extern "C" { # [ doc = " Serializes given @p layout into buffer @p buf. User-provided buffer @p buf" ] # [ doc = " should have enough space to store dnnLayout_t structure." ] # [ doc = " @sa dnnLayoutSerializationBufferSize_F32" ] pub fn dnnLayoutSerialize_F32 ( layout : dnnLayout_t , buf : * mut :: std :: os :: raw :: c_void ) -> dnnError_t;
} extern "C" { # [ doc = " Creates new layout restored from previously serialized one." ] pub fn dnnLayoutDeserialize_F32 ( pLayout : * mut dnnLayout_t , buf : * const :: std :: os :: raw :: c_void ) -> dnnError_t;
} extern "C" { pub fn dnnLayoutGetMemorySize_F32 ( layout : dnnLayout_t ) -> usize;
} extern "C" { pub fn dnnLayoutCompare_F32 ( l1 : dnnLayout_t , l2 : dnnLayout_t ) -> :: std :: os :: raw :: c_int;
} extern "C" { pub fn dnnAllocateBuffer_F32 ( pPtr : * mut * mut :: std :: os :: raw :: c_void , layout : dnnLayout_t ) -> dnnError_t;
} extern "C" { pub fn dnnReleaseBuffer_F32 ( ptr : * mut :: std :: os :: raw :: c_void ) -> dnnError_t;
} extern "C" { pub fn dnnLayoutDelete_F32 ( layout : dnnLayout_t ) -> dnnError_t;
} extern "C" { pub fn dnnPrimitiveAttributesCreate_F32 ( attributes : * mut dnnPrimitiveAttributes_t ) -> dnnError_t;
} extern "C" { pub fn dnnPrimitiveAttributesDestroy_F32 ( attributes : dnnPrimitiveAttributes_t ) -> dnnError_t;
} extern "C" { pub fn dnnPrimitiveGetAttributes_F32 ( primitive : dnnPrimitive_t , attributes : * mut dnnPrimitiveAttributes_t ) -> dnnError_t;
} extern "C" { pub fn dnnExecute_F32 ( primitive : dnnPrimitive_t , resources : * mut * mut :: std :: os :: raw :: c_void ) -> dnnError_t;
} extern "C" { pub fn dnnExecuteAsync_F32 ( primitive : dnnPrimitive_t , resources : * mut * mut :: std :: os :: raw :: c_void ) -> dnnError_t;
} extern "C" { pub fn dnnWaitFor_F32 ( primitive : dnnPrimitive_t ) -> dnnError_t;
} extern "C" { pub fn dnnDelete_F32 ( primitive : dnnPrimitive_t ) -> dnnError_t;
} extern "C" { pub fn dnnConversionCreate_F32 ( pConversion : * mut dnnPrimitive_t , from : dnnLayout_t , to : dnnLayout_t ) -> dnnError_t;
} extern "C" { pub fn dnnConversionExecute_F32 ( conversion : dnnPrimitive_t , from : * mut :: std :: os :: raw :: c_void , to : * mut :: std :: os :: raw :: c_void ) -> dnnError_t;
} extern "C" { pub fn dnnSumCreate_F32 ( pSum : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , nSummands : usize , layout : dnnLayout_t , coefficients : * mut f32 ) -> dnnError_t;
} extern "C" { pub fn dnnConcatCreate_F32 ( pConcat : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , nSrcTensors : usize , src : * mut dnnLayout_t ) -> dnnError_t;
} extern "C" { pub fn dnnSplitCreate_F32 ( pSplit : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , nDstTensors : usize , layout : dnnLayout_t , dstChannelSize : * mut usize ) -> dnnError_t;
} extern "C" { pub fn dnnScaleCreate_F32 ( pScale : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dataLayout : dnnLayout_t , alpha : f32 ) -> dnnError_t;
} extern "C" { pub fn dnnConvolutionCreateForward_F32 ( pConvolution : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , algorithm : dnnAlgorithm_t , dimension : usize , srcSize : * const usize , dstSize : * const usize , filterSize : * const usize , convolutionStrides : * const usize , inputOffset : * const :: std :: os :: raw :: c_int , borderType : dnnBorder_t ) -> dnnError_t;
} extern "C" { pub fn dnnConvolutionCreateForwardBias_F32 ( pConvolution : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , algorithm : dnnAlgorithm_t , dimension : usize , srcSize : * const usize , dstSize : * const usize , filterSize : * const usize , convolutionStrides : * const usize , inputOffset : * const :: std :: os :: raw :: c_int , borderType : dnnBorder_t ) -> dnnError_t;
} extern "C" { pub fn dnnConvolutionCreateBackwardData_F32 ( pConvolution : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , algorithm : dnnAlgorithm_t , dimension : usize , srcSize : * const usize , dstSize : * const usize , filterSize : * const usize , convolutionStrides : * const usize , inputOffset : * const :: std :: os :: raw :: c_int , borderType : dnnBorder_t ) -> dnnError_t;
} extern "C" { pub fn dnnConvolutionCreateBackwardFilter_F32 ( pConvolution : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , algorithm : dnnAlgorithm_t , dimension : usize , srcSize : * const usize , dstSize : * const usize , filterSize : * const usize , convolutionStrides : * const usize , inputOffset : * const :: std :: os :: raw :: c_int , borderType : dnnBorder_t ) -> dnnError_t;
} extern "C" { pub fn dnnConvolutionCreateBackwardBias_F32 ( pConvolution : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , algorithm : dnnAlgorithm_t , dimension : usize , dstSize : * const usize ) -> dnnError_t;
} extern "C" { pub fn dnnGroupsConvolutionCreateForward_F32 ( pConvolution : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , algorithm : dnnAlgorithm_t , groups : usize , dimension : usize , srcSize : * const usize , dstSize : * const usize , filterSize : * const usize , convolutionStrides : * const usize , inputOffset : * const :: std :: os :: raw :: c_int , borderType : dnnBorder_t ) -> dnnError_t;
} extern "C" { pub fn dnnGroupsConvolutionCreateForwardBias_F32 ( pConvolution : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , algorithm : dnnAlgorithm_t , groups : usize , dimension : usize , srcSize : * const usize , dstSize : * const usize , filterSize : * const usize , convolutionStrides : * const usize , inputOffset : * const :: std :: os :: raw :: c_int , borderType : dnnBorder_t ) -> dnnError_t;
} extern "C" { pub fn dnnGroupsConvolutionCreateBackwardData_F32 ( pConvolution : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , algorithm : dnnAlgorithm_t , groups : usize , dimension : usize , srcSize : * const usize , dstSize : * const usize , filterSize : * const usize , convolutionStrides : * const usize , inputOffset : * const :: std :: os :: raw :: c_int , borderType : dnnBorder_t ) -> dnnError_t;
} extern "C" { pub fn dnnGroupsConvolutionCreateBackwardFilter_F32 ( pConvolution : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , algorithm : dnnAlgorithm_t , groups : usize , dimension : usize , srcSize : * const usize , dstSize : * const usize , filterSize : * const usize , convolutionStrides : * const usize , inputOffset : * const :: std :: os :: raw :: c_int , borderType : dnnBorder_t ) -> dnnError_t;
} extern "C" { pub fn dnnGroupsConvolutionCreateBackwardBias_F32 ( pConvolution : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , algorithm : dnnAlgorithm_t , groups : usize , dimension : usize , dstSize : * const usize ) -> dnnError_t;
} extern "C" { pub fn dnnReLUCreateForward_F32 ( pRelu : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dataLayout : dnnLayout_t , negativeSlope : f32 ) -> dnnError_t;
} extern "C" { pub fn dnnReLUCreateBackward_F32 ( pRelu : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , diffLayout : dnnLayout_t , dataLayout : dnnLayout_t , negativeSlope : f32 ) -> dnnError_t;
} extern "C" { pub fn dnnLRNCreateForward_F32 ( pLrn : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dataLayout : dnnLayout_t , kernel_size : usize , alpha : f32 , beta : f32 , k : f32 ) -> dnnError_t;
} extern "C" { pub fn dnnLRNCreateBackward_F32 ( pLrn : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , diffLayout : dnnLayout_t , dataLayout : dnnLayout_t , kernel_size : usize , alpha : f32 , beta : f32 , k : f32 ) -> dnnError_t;
} extern "C" { pub fn dnnBatchNormalizationCreateForward_F32 ( pBatchNormalization : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dataLayout : dnnLayout_t , eps : f32 ) -> dnnError_t;
} extern "C" { pub fn dnnBatchNormalizationCreateBackwardScaleShift_F32 ( pBatchNormalization : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dataLayout : dnnLayout_t , eps : f32 ) -> dnnError_t;
} extern "C" { pub fn dnnBatchNormalizationCreateBackwardData_F32 ( pBatchNormalization : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dataLayout : dnnLayout_t , eps : f32 ) -> dnnError_t;
} extern "C" { pub fn dnnBatchNormalizationCreateForward_v2_F32 ( pBatchNormalization : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dataLayout : dnnLayout_t , eps : f32 , flags : :: std :: os :: raw :: c_uint ) -> dnnError_t;
} extern "C" { pub fn dnnBatchNormalizationCreateBackward_v2_F32 ( pBatchNormalization : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dataLayout : dnnLayout_t , eps : f32 , flags : :: std :: os :: raw :: c_uint ) -> dnnError_t;
} extern "C" { pub fn dnnPoolingCreateForward_F32 ( pPooling : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , op : dnnAlgorithm_t , srcLayout : dnnLayout_t , kernelSize : * const usize , kernelStride : * const usize , inputOffset : * const :: std :: os :: raw :: c_int , borderType : dnnBorder_t ) -> dnnError_t;
} extern "C" { pub fn dnnPoolingCreateBackward_F32 ( pPooling : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , op : dnnAlgorithm_t , srcLayout : dnnLayout_t , kernelSize : * const usize , kernelStride : * const usize , inputOffset : * const :: std :: os :: raw :: c_int , borderType : dnnBorder_t ) -> dnnError_t;
} extern "C" { pub fn dnnInnerProductCreateForward_F32 ( pInnerProduct : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dimensions : usize , srcSize : * const usize , outputChannels : usize ) -> dnnError_t;
} extern "C" { pub fn dnnInnerProductCreateForwardBias_F32 ( pInnerProduct : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dimensions : usize , srcSize : * const usize , outputChannels : usize ) -> dnnError_t;
} extern "C" { pub fn dnnInnerProductCreateBackwardData_F32 ( pInnerProduct : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dimensions : usize , srcSize : * const usize , outputChannels : usize ) -> dnnError_t;
} extern "C" { pub fn dnnInnerProductCreateBackwardFilter_F32 ( pInnerProduct : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dimensions : usize , srcSize : * const usize , outputChannels : usize ) -> dnnError_t;
} extern "C" { pub fn dnnInnerProductCreateBackwardBias_F32 ( pInnerProduct : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dimensions : usize , dstSize : * const usize ) -> dnnError_t;
} extern "C" { # [ doc = " F64 section: double precision" ] pub fn dnnLayoutCreate_F64 ( pLayout : * mut dnnLayout_t , dimension : usize , size : * const usize , strides : * const usize ) -> dnnError_t;
} extern "C" { pub fn dnnLayoutCreateFromPrimitive_F64 ( pLayout : * mut dnnLayout_t , primitive : dnnPrimitive_t , type_ : dnnResourceType_t ) -> dnnError_t;
} extern "C" { # [ doc = " Returns the size of buffer required to serialize dnnLayout_t structure." ] pub fn dnnLayoutSerializationBufferSize_F64 ( ) -> usize;
} extern "C" { # [ doc = " Serializes given @p layout into buffer @p buf. User-provided buffer @p buf" ] # [ doc = " should have enough space to store dnnLayout_t structure." ] # [ doc = " @sa dnnLayoutSerializationBufferSize_F64" ] pub fn dnnLayoutSerialize_F64 ( layout : dnnLayout_t , buf : * mut :: std :: os :: raw :: c_void ) -> dnnError_t;
} extern "C" { # [ doc = " Creates new layout restored from previously serialized one." ] pub fn dnnLayoutDeserialize_F64 ( pLayout : * mut dnnLayout_t , buf : * const :: std :: os :: raw :: c_void ) -> dnnError_t;
} extern "C" { pub fn dnnLayoutGetMemorySize_F64 ( layout : dnnLayout_t ) -> usize;
} extern "C" { pub fn dnnLayoutCompare_F64 ( l1 : dnnLayout_t , l2 : dnnLayout_t ) -> :: std :: os :: raw :: c_int;
} extern "C" { pub fn dnnAllocateBuffer_F64 ( pPtr : * mut * mut :: std :: os :: raw :: c_void , layout : dnnLayout_t ) -> dnnError_t;
} extern "C" { pub fn dnnReleaseBuffer_F64 ( ptr : * mut :: std :: os :: raw :: c_void ) -> dnnError_t;
} extern "C" { pub fn dnnLayoutDelete_F64 ( layout : dnnLayout_t ) -> dnnError_t;
} extern "C" { pub fn dnnPrimitiveAttributesCreate_F64 ( attributes : * mut dnnPrimitiveAttributes_t ) -> dnnError_t;
} extern "C" { pub fn dnnPrimitiveAttributesDestroy_F64 ( attributes : dnnPrimitiveAttributes_t ) -> dnnError_t;
} extern "C" { pub fn dnnPrimitiveGetAttributes_F64 ( primitive : dnnPrimitive_t , attributes : * mut dnnPrimitiveAttributes_t ) -> dnnError_t;
} extern "C" { pub fn dnnExecute_F64 ( primitive : dnnPrimitive_t , resources : * mut * mut :: std :: os :: raw :: c_void ) -> dnnError_t;
} extern "C" { pub fn dnnExecuteAsync_F64 ( primitive : dnnPrimitive_t , resources : * mut * mut :: std :: os :: raw :: c_void ) -> dnnError_t;
} extern "C" { pub fn dnnWaitFor_F64 ( primitive : dnnPrimitive_t ) -> dnnError_t;
} extern "C" { pub fn dnnDelete_F64 ( primitive : dnnPrimitive_t ) -> dnnError_t;
} extern "C" { pub fn dnnConversionCreate_F64 ( pConversion : * mut dnnPrimitive_t , from : dnnLayout_t , to : dnnLayout_t ) -> dnnError_t;
} extern "C" { pub fn dnnConversionExecute_F64 ( conversion : dnnPrimitive_t , from : * mut :: std :: os :: raw :: c_void , to : * mut :: std :: os :: raw :: c_void ) -> dnnError_t;
} extern "C" { pub fn dnnSumCreate_F64 ( pSum : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , nSummands : usize , layout : dnnLayout_t , coefficients : * mut f64 ) -> dnnError_t;
} extern "C" { pub fn dnnConcatCreate_F64 ( pConcat : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , nSrcTensors : usize , src : * mut dnnLayout_t ) -> dnnError_t;
} extern "C" { pub fn dnnSplitCreate_F64 ( pSplit : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , nDstTensors : usize , layout : dnnLayout_t , dstChannelSize : * mut usize ) -> dnnError_t;
} extern "C" { pub fn dnnScaleCreate_F64 ( pScale : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dataLayout : dnnLayout_t , alpha : f64 ) -> dnnError_t;
} extern "C" { pub fn dnnConvolutionCreateForward_F64 ( pConvolution : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , algorithm : dnnAlgorithm_t , dimension : usize , srcSize : * const usize , dstSize : * const usize , filterSize : * const usize , convolutionStrides : * const usize , inputOffset : * const :: std :: os :: raw :: c_int , borderType : dnnBorder_t ) -> dnnError_t;
} extern "C" { pub fn dnnConvolutionCreateForwardBias_F64 ( pConvolution : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , algorithm : dnnAlgorithm_t , dimension : usize , srcSize : * const usize , dstSize : * const usize , filterSize : * const usize , convolutionStrides : * const usize , inputOffset : * const :: std :: os :: raw :: c_int , borderType : dnnBorder_t ) -> dnnError_t;
} extern "C" { pub fn dnnConvolutionCreateBackwardData_F64 ( pConvolution : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , algorithm : dnnAlgorithm_t , dimension : usize , srcSize : * const usize , dstSize : * const usize , filterSize : * const usize , convolutionStrides : * const usize , inputOffset : * const :: std :: os :: raw :: c_int , borderType : dnnBorder_t ) -> dnnError_t;
} extern "C" { pub fn dnnConvolutionCreateBackwardFilter_F64 ( pConvolution : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , algorithm : dnnAlgorithm_t , dimension : usize , srcSize : * const usize , dstSize : * const usize , filterSize : * const usize , convolutionStrides : * const usize , inputOffset : * const :: std :: os :: raw :: c_int , borderType : dnnBorder_t ) -> dnnError_t;
} extern "C" { pub fn dnnConvolutionCreateBackwardBias_F64 ( pConvolution : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , algorithm : dnnAlgorithm_t , dimension : usize , dstSize : * const usize ) -> dnnError_t;
} extern "C" { pub fn dnnGroupsConvolutionCreateForward_F64 ( pConvolution : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , algorithm : dnnAlgorithm_t , groups : usize , dimension : usize , srcSize : * const usize , dstSize : * const usize , filterSize : * const usize , convolutionStrides : * const usize , inputOffset : * const :: std :: os :: raw :: c_int , borderType : dnnBorder_t ) -> dnnError_t;
} extern "C" { pub fn dnnGroupsConvolutionCreateForwardBias_F64 ( pConvolution : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , algorithm : dnnAlgorithm_t , groups : usize , dimension : usize , srcSize : * const usize , dstSize : * const usize , filterSize : * const usize , convolutionStrides : * const usize , inputOffset : * const :: std :: os :: raw :: c_int , borderType : dnnBorder_t ) -> dnnError_t;
} extern "C" { pub fn dnnGroupsConvolutionCreateBackwardData_F64 ( pConvolution : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , algorithm : dnnAlgorithm_t , groups : usize , dimension : usize , srcSize : * const usize , dstSize : * const usize , filterSize : * const usize , convolutionStrides : * const usize , inputOffset : * const :: std :: os :: raw :: c_int , borderType : dnnBorder_t ) -> dnnError_t;
} extern "C" { pub fn dnnGroupsConvolutionCreateBackwardFilter_F64 ( pConvolution : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , algorithm : dnnAlgorithm_t , groups : usize , dimension : usize , srcSize : * const usize , dstSize : * const usize , filterSize : * const usize , convolutionStrides : * const usize , inputOffset : * const :: std :: os :: raw :: c_int , borderType : dnnBorder_t ) -> dnnError_t;
} extern "C" { pub fn dnnGroupsConvolutionCreateBackwardBias_F64 ( pConvolution : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , algorithm : dnnAlgorithm_t , groups : usize , dimension : usize , dstSize : * const usize ) -> dnnError_t;
} extern "C" { pub fn dnnReLUCreateForward_F64 ( pRelu : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dataLayout : dnnLayout_t , negativeSlope : f64 ) -> dnnError_t;
} extern "C" { pub fn dnnReLUCreateBackward_F64 ( pRelu : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , diffLayout : dnnLayout_t , dataLayout : dnnLayout_t , negativeSlope : f64 ) -> dnnError_t;
} extern "C" { pub fn dnnLRNCreateForward_F64 ( pLrn : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dataLayout : dnnLayout_t , kernel_size : usize , alpha : f64 , beta : f64 , k : f64 ) -> dnnError_t;
} extern "C" { pub fn dnnLRNCreateBackward_F64 ( pLrn : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , diffLayout : dnnLayout_t , dataLayout : dnnLayout_t , kernel_size : usize , alpha : f64 , beta : f64 , k : f64 ) -> dnnError_t;
} extern "C" { pub fn dnnBatchNormalizationCreateForward_F64 ( pBatchNormalization : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dataLayout : dnnLayout_t , eps : f64 ) -> dnnError_t;
} extern "C" { pub fn dnnBatchNormalizationCreateBackwardScaleShift_F64 ( pBatchNormalization : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dataLayout : dnnLayout_t , eps : f64 ) -> dnnError_t;
} extern "C" { pub fn dnnBatchNormalizationCreateBackwardData_F64 ( pBatchNormalization : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dataLayout : dnnLayout_t , eps : f64 ) -> dnnError_t;
} extern "C" { pub fn dnnBatchNormalizationCreateForward_v2_F64 ( pBatchNormalization : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dataLayout : dnnLayout_t , eps : f64 , flags : :: std :: os :: raw :: c_uint ) -> dnnError_t;
} extern "C" { pub fn dnnBatchNormalizationCreateBackward_v2_F64 ( pBatchNormalization : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dataLayout : dnnLayout_t , eps : f64 , flags : :: std :: os :: raw :: c_uint ) -> dnnError_t;
} extern "C" { pub fn dnnPoolingCreateForward_F64 ( pPooling : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , op : dnnAlgorithm_t , srcLayout : dnnLayout_t , kernelSize : * const usize , kernelStride : * const usize , inputOffset : * const :: std :: os :: raw :: c_int , borderType : dnnBorder_t ) -> dnnError_t;
} extern "C" { pub fn dnnPoolingCreateBackward_F64 ( pPooling : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , op : dnnAlgorithm_t , srcLayout : dnnLayout_t , kernelSize : * const usize , kernelStride : * const usize , inputOffset : * const :: std :: os :: raw :: c_int , borderType : dnnBorder_t ) -> dnnError_t;
} extern "C" { pub fn dnnInnerProductCreateForward_F64 ( pInnerProduct : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dimensions : usize , srcSize : * const usize , outputChannels : usize ) -> dnnError_t;
} extern "C" { pub fn dnnInnerProductCreateForwardBias_F64 ( pInnerProduct : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dimensions : usize , srcSize : * const usize , outputChannels : usize ) -> dnnError_t;
} extern "C" { pub fn dnnInnerProductCreateBackwardData_F64 ( pInnerProduct : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dimensions : usize , srcSize : * const usize , outputChannels : usize ) -> dnnError_t;
} extern "C" { pub fn dnnInnerProductCreateBackwardFilter_F64 ( pInnerProduct : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dimensions : usize , srcSize : * const usize , outputChannels : usize ) -> dnnError_t;
} extern "C" { pub fn dnnInnerProductCreateBackwardBias_F64 ( pInnerProduct : * mut dnnPrimitive_t , attributes : dnnPrimitiveAttributes_t , dimensions : usize , dstSize : * const usize ) -> dnnError_t;
} pub type __builtin_va_list = [ __va_list_tag;
1usize ];
# [ repr ( C ) ] # [ derive ( Debug , Copy , Clone ) ] pub struct __va_list_tag { pub gp_offset : :: std :: os :: raw :: c_uint , pub fp_offset : :: std :: os :: raw :: c_uint , pub overflow_arg_area : * mut :: std :: os :: raw :: c_void , pub reg_save_area : * mut :: std :: os :: raw :: c_void , } # [ test ] fn bindgen_test_layout___va_list_tag ( ) { assert_eq ! ( :: std :: mem :: size_of :: < __va_list_tag > ( ) , 24usize , concat ! ( "Size of: " , stringify ! ( __va_list_tag ) ) );
