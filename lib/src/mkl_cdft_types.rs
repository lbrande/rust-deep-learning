...
pub const CDFT_MPI_ERROR : u32 = 1000;
pub const CDFT_SPREAD_ERROR : u32 = 1001;
...
} pub const CDFT_CONFIG_PARAM_CDFT_LOCAL_SIZE : CDFT_CONFIG_PARAM = 1000;
pub const CDFT_CONFIG_PARAM_CDFT_LOCAL_X_START : CDFT_CONFIG_PARAM = 1001;
pub const CDFT_CONFIG_PARAM_CDFT_LOCAL_NX : CDFT_CONFIG_PARAM = 1002;
pub const CDFT_CONFIG_PARAM_CDFT_MPI_COMM : CDFT_CONFIG_PARAM = 1003;
pub const CDFT_CONFIG_PARAM_CDFT_WORKSPACE : CDFT_CONFIG_PARAM = 1004;
pub const CDFT_CONFIG_PARAM_CDFT_LOCAL_OUT_X_START : CDFT_CONFIG_PARAM = 1005;
pub const CDFT_CONFIG_PARAM_CDFT_LOCAL_OUT_NX : CDFT_CONFIG_PARAM = 1006;
pub type CDFT_CONFIG_PARAM = u32;
# [ repr ( C ) ] # [ derive ( Debug , Copy , Clone ) ] pub struct _DFTI_DESCRIPTOR_DM { _unused : [ u8;
0 ] , } pub type DFTI_DESCRIPTOR_DM_HANDLE = * mut _DFTI_DESCRIPTOR_DM ;