...
} pub type i_malloc_t = :: std :: option :: Option < unsafe extern "C" fn ( size : usize ) -> * mut :: std :: os :: raw :: c_void >;
pub type i_calloc_t = :: std :: option :: Option < unsafe extern "C" fn ( nmemb : usize , size : usize ) -> * mut :: std :: os :: raw :: c_void >;
pub type i_realloc_t = :: std :: option :: Option < unsafe extern "C" fn ( ptr : * mut :: std :: os :: raw :: c_void , size : usize ) -> * mut :: std :: os :: raw :: c_void >;
pub type i_free_t = :: std :: option :: Option < unsafe extern "C" fn ( ptr : * mut :: std :: os :: raw :: c_void ) >;
extern "C" { pub static mut i_malloc : i_malloc_t;
} extern "C" { pub static mut i_calloc : i_calloc_t;
} extern "C" { pub static mut i_realloc : i_realloc_t;
} extern "C" { pub static mut i_free : i_free_t;
}